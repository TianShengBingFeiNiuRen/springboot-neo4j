...
public class HttpClientUtil {
     ...
     * 发送post请求;带请求头和请求参数
     */
    public static String doPostParam(String url, Map<String, String> headers, Map<String, String> params) throws Exception {
        // 创建httpClient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
     ...
     * 发送post请求;带请求参数
     */
    public static String doPostParam(String url, Map<String, String> params) throws Exception {
        return doPostParam(url, null, params);
    }

    /**
     * 发送post请求;不带请求头和请求参数
     */
    public static String doPostParam(String url) throws Exception {
        return doPostParam(url, null, null);
    }
